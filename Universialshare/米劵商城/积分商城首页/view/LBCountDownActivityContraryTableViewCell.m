//
//  LBCountDownActivityContraryTableViewCell.m
//  Universialshare
//
...
@interface LBCountDownActivityContraryTableViewCell ()
...
@implementation LBCountDownActivityContraryTableViewCell
-(void)dealloc{
...
//    self.titileLb.textAlignment  =  NSTextAlignmentCenter;
    ...
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:self.titleview.bounds byRoundingCorners:UIRectCornerTopLeft |UIRectCornerBottomLeft cornerRadii:CGSizeMake(15,15)];
