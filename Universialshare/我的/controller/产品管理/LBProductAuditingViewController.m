//
//  LBProductAuditingViewController.m
//  Universialshare
//
...
@interface LBProductAuditingViewController ()<UITableViewDelegate,UITableViewDataSource,UIAlertViewDelegate,SUDropMenuDelegate>
...
@implementation LBProductAuditingViewController
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(refreshdatasource) name:@"addproduct" object:nil];
}
...
-(void)initdatasource{
    ...
    [NetworkManager requestPOSTWithURLStr:@"Shop/getStoreGoodsList" paramDic:@{@"uid":[UserModel defaultUser].uid , @"token":[UserModel defaultUser].token , @"page" :[NSNumber numberWithInteger:self.page],@"type":@"3"} finish:^(id responseObject) {
...
-(SUPopupMenu*)popupView{
    ...
    if (!_popupView) {
        _popupView = [[SUPopupMenu alloc] initWithTitles: @[@"停止审核"] icons: nil menuItemSize:CGSizeMake(110, 44)];
