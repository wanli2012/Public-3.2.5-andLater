...
//    CGSize size = [str1 sizeWithFont:[UIFont systemFontOfSize:18] constrainedToSize:CGSizeMake(self.frame.size.width-10, 9999999999999999)];
    CGSize size = [str1 sizeWithAttributes:@{ NSFontAttributeName : [UIFont fontWithName:@"HelveticaNeue-Light" size:18.0] }];
    ...
    [surebtn setBackgroundColor:YYSRGBColor(40, 150, 58, 1)];
