//
//  GLMyHeartOnLineRecoderController.m
//  Universialshare
//
...
@interface GLMyHeartOnLineRecoderController ()<UITableViewDataSource,UITableViewDelegate>
{
    LoadWaitView *_loadV;
}
...
@implementation GLMyHeartOnLineRecoderController
