//
//  LBMineCenterUsualUnderOrderfourViewController.m
//  Universialshare
//
//  Created by 四川三君科技有限公司 on 2017/10/18.
...
@interface LBMineCenterUsualUnderOrderfourViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LBMineCenterUsualUnderOrderfourViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.momey.text = [NSString stringWithFormat:@"订单金额:¥%@",self.dataarr[indexPath.row][@"line_money"]];
