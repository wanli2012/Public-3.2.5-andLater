//
//  LBBillOfLadingAuditRecoderListViewController.m
//  Universialshare
//
...
@interface LBBillOfLadingAuditRecoderListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LBBillOfLadingAuditRecoderListViewController
...
- (void)postRequest {
    ...
    [NetworkManager requestPOSTWithURLStr:@"User/getMainOrderSon" paramDic:dict finish:^(id responseObject) {
