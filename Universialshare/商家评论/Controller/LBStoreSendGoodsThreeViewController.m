//
//  LBStoreSendGoodsThreeViewController.m
//  Universialshare
//
//  Created by 四川三君科技有限公司 on 2017/11/16.
...
@interface LBStoreSendGoodsThreeViewController ()
...
@implementation LBStoreSendGoodsThreeViewController
...
-(void)initdatasource{
    ...
    [NetworkManager requestPOSTWithURLStr:@"Shop/waitConfirm" paramDic:@{@"uid":[UserModel defaultUser].uid , @"token":[UserModel defaultUser].token , @"page" :[NSNumber numberWithInteger:self.page]} finish:^(id responseObject) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    LBWaitOrdersModel *model = self.dataarr[indexPath.section];
    cell.WaitOrdersListModelone = model.dataArr[indexPath.row-1];
    return cell;
