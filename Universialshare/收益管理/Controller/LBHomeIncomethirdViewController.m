//
//  LBHomeIncomethirdViewController.m
//  Universialshare
//
...
@interface LBHomeIncomethirdViewController ()<UITableViewDelegate,UITableViewDataSource,HWCalendarDelegate>
...
static NSString *ID = @"GLTeam_IncomeCell";

@implementation LBHomeIncomethirdViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    GLTeam_IncomeCell *cell = [tableView dequeueReusableCellWithIdentifier:ID forIndexPath:indexPath];
