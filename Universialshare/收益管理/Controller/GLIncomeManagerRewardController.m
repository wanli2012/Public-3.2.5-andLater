//
//  GLIncomeManagerRewardController.m
//  Universialshare
//
...
@interface GLIncomeManagerRewardController ()<UITableViewDataSource,UITableViewDelegate,HWCalendarDelegate>
...
@implementation GLIncomeManagerRewardController
    ...
    [NetworkManager requestPOSTWithURLStr:@"User/getUserAchievement" paramDic:dic finish:^(id responseObject) {
        ...
        if ([responseObject[@"code"] integerValue]==1) {
            ...
            for (NSDictionary *dic in responseObject[@"data"]) {
                GLIncomeRewardModel *model = [GLIncomeRewardModel mj_objectWithKeyValues:dic];
