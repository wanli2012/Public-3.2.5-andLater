...
- (void)onRecvRevokeMessageNotification:(NIMRevokeMessageNotification *)notification
{
   ...
   BasetabbarViewController  *tabVC = [BasetabbarViewController instance];
        ...
        if ([dict isKindOfClass:[NSDictionary class]])
        {
            switch ([dict jsonInteger:NTESNotifyID]) {
                case NTESCustom:{
                    ...
                    [[BasetabbarViewController instance].selectedViewController.view makeToast:content duration:2.0 position:CSToastPositionCenter];
                }
                    break;
...
{
    BasetabbarViewController *tab = [BasetabbarViewController instance];
    [tab.view endEditing:YES];
    if (tab.presentedViewController) {
        __weak BasetabbarViewController *wtabVC = tab;
...
{
    UINavigationController *nav = [BasetabbarViewController instance].selectedViewController;
    for (UIViewController *vc in nav.viewControllers)
    {
