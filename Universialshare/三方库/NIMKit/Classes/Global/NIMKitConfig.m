...
- (void)applyDefaultTextSettings
{
    ...
    _textSetting.font1      = [UIFont systemFontOfSize:14];
...
- (void)applyDefaultAudioSettings
{
    ...
    _audioSetting.font1      = [UIFont systemFontOfSize:14];
...
- (void)applyDefaultVideoSettings
{
    ...
    _videoSetting.font1      = [UIFont systemFontOfSize:14];
...
- (void)applyDefaultFileSettings
{
    ...
    _fileSetting.font1      = [UIFont systemFontOfSize:14];
...
- (void)applyDefaultLocationSettings
{
    ...
    _locationSetting.font1      = [UIFont systemFontOfSize:12];
...
- (void)applyDefaultTipSettings
{
    ...
    _tipSetting.font1  = [UIFont systemFontOfSize:10.f];
...
- (void)applyDefaultRobotSettings
{
    ...
    _robotSetting.font1      = [UIFont systemFontOfSize:14];
...
- (void)applyDefaultUnsupportSettings
{
    ...
    _unsupportSetting.font1      = [UIFont systemFontOfSize:14];
...
- (void)applyDefaultTeamNotificationSettings
{
    ...
    _teamNotificationSetting.font1      = [UIFont systemFontOfSize:10];
...
- (void)applyDefaultChatroomNotificationSettings
{
    ...
    _chatroomNotificationSetting.font1      = [UIFont systemFontOfSize:10];
...
- (void)applyDefaultNetcallNotificationSettings
{
    ...
    _netcallNotificationSetting.font1      = [UIFont systemFontOfSize:14];
